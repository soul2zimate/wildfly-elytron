        ...
        return new CallbackHandler() {
            ...
            private void handleOne(final Callback[] callbacks, final int idx) throws IOException, UnsupportedCallbackException {
                ...
                if (callback instanceof AnonymousAuthorizationCallback) {
                    ...
                    MechanismConfiguration mechnismConfiguration  = stateRef.get().getMechanismConfiguration();
                    if (mechnismConfiguration == null) {
                        throw log.emptyMechnismConfiguration();
                    }
                    CredentialSource serverCredentialSource = mechnismConfiguration.getServerCredentialSource();
